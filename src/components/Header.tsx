...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 w-full border-b p-4 font-serif italic flex flex-wrap gap-4 justify-between bg-neutral-100">
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="font-sans p-2 bg-white border border-black font-semibold"
        >
